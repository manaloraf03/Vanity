            ...
            <td>
                ...
                <div class="tab-container tab-top tab-default">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#journal_review_<?php echo $issuance_department_info->issuance_department_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
                        <li class=""><a href="#purchase_review_<?php echo $issuance_department_info->issuance_department_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="journal_review_<?php echo $issuance_department_info->issuance_department_id; ?>" data-parent-id="<?php echo $issuance_department_info->issuance_department_id; ?>" style="min-height: 300px;">
                            ...
                            <input type="hidden" name="ref_no" value="<?php echo $issuance_department_info->trn_no; ?>">
                            <input type="hidden" name="trn_type" value="<?php echo $trn_type; ?>">
                                ...
                                <hr />
                                <div style="width: 90%;">
                                    <input type="hidden" name="issuance_department_id" value="<?php echo $issuance_department_info->issuance_department_id; ?>">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="date_txn" class="date-picker  form-control" value="<?php echo $issuance_department_info->date_issued; ?>">
                                    </div>
                                    <br /><br />
                                    ...
                                    <div class="col-lg-10">
                                        <select name="department_id" class="cbo_department_list" data-error-msg="" required>
                                            <?php foreach($departments as $department){ ?>
                                                <option value="<?php echo $department->department_id; ?>" <?php echo ($issuance_branch_id===$department->department_id?'selected':''); ?>><?php echo $department->department_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <hr />
                                <table id="tbl_entries_for_review_<?php echo $issuance_department_info->issuance_department_id; ?>" class="table table-striped" style="width: 100% !important;">
                                    <thead>
                        ...
                        <div class="tab-pane" id="purchase_review_<?php echo $issuance_department_info->issuance_department_id; ?>" >
                                <h4><span style="margin-left: 1%"><strong><i class="fa fa-bars"></i> Issuance</strong></span></h4>
                                <hr />
                                <div style="margin-left: 2%;margin-right: 20px;">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <i class="fa fa-code"></i> Issuance Transfer # : <?php echo $issuance_department_info->trn_no; ?><br />
                                            <i class="fa fa-calendar"></i> Terms : <?php echo $issuance_department_info->terms; ?><br />
                                            <i class="fa fa-calendar-o"></i> Issuance Date : <?php echo $issuance_department_info->date_issued; ?><br />
                                            <i class="fa fa-file-o"></i> Remarks : <?php echo $issuance_department_info->remarks; ?><br />
                                        </div>
                                        <div class="col-lg-6">
                                            <i class="fa fa-user"></i> Posted by : <?php echo $issuance_department_info->posted_by; ?><br />
                                            <i class="fa fa-calendar"></i> Date : <?php echo $issuance_department_info->date_created; ?><br />
                                        </div>
                                    </div>
                                    <br /><br />
