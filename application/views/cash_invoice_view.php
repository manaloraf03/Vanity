                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body table-responsive" style="width: 100%;overflow-x: hidden;">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Cash Invoice</h2>
                                                    <hr>
                                                    <div class="row">
            ...
            <footer role="contentinfo">
                <div class="clearfix">
                    <ul class="list-unstyled list-inline pull-left">
                        <li>
                            <h6 style="margin: 0;">&copy; 2018 - JDEV OFFICE SOLUTIONS</h6>
                        </li>
                    </ul>
    ...
    <script>
        $(document).ready(function() {
            ...
            var oTableItems = {
                ...
                weight: 'td:eq(3)',
                total_weight: 'td:eq(4)',
                unit_price: 'td:eq(5)',
                discount: 'td:eq(6)',
                total_line_discount: 'td:eq(7)',
                tax: 'td:eq(8)',
                gross: 'td:eq(9)',
                total: 'td:eq(10)',
                vat_input: 'td:eq(11)',
            ...
            var bindEventHandlers = (function() {
                ...
                $('#tbl_cash_invoice tbody').on('click', 'button[name="print_weight"]', function() {
                    var tr = $(this).closest('tr');
                    var row = dt.row(tr);
                    var d = row.data();
                    window.open('Templates/layout/cash-invoice/' + d.cash_invoice_id + '?type=print_weight');
                });
                        ...
                        success: function(response) {
                            ...
                            $.each(rows, function(i, value) {
                                ...
                                $('#tbl_items > tbody').append(newRowItem({
                                    ...
                                    a: a,
                                    weight: value.weight,
                                    total_weight: value.weight * value.so_qty
                                }));
                                _line_unit = $('.line_unit' + a).select2({
                                    minimumResultsForSearch: -1
                                });
                ...
                $('#tbl_cash_invoice tbody').on('click', 'button[name="edit_info"]', function() {
                    ...
                    if (_is_journal_posted > 0) {
                        showNotification({
                            ...
                            stat: "error",
                            msg: "Cannot Edit: Invoice is already Posted in Cash Receipt Journal."
                        });
                    } else if (_count > 0) {
                        showNotification({
                            title: "<b style='color:white;'> Error!</b> ",
                            stat: "error",
                            msg: "Cannot Edit: Invoice is already in use in Collection Entry."
                        });
                    } else {
                            ...
                            success: function(response) {
                                ...
                                $.each(rows, function(i, value) {
                                    ...
                                    $('#tbl_items > tbody').append(newRowItem({
                                        ...
                                        a: a,
                                        weight: value.weight,
                                        total_weight: value.weight * value.inv_qty
                                    }));
                                    changetxn = 'inactive';
                                    _line_unit = $('.line_unit' + a).select2({
                                        minimumResultsForSearch: -1
                    ...
                    $.ajax({
                        ...
                        if (_is_journal_posted > 0) {
                            showNotification({
                                title: "<b style='color:white;'> Error!</b> ",
                                stat: "error",
                                msg: "Cannot Delete: Invoice is already Posted in Cash Receipt Journal."
                            });
                        } else if (_count > 0) {
                            showNotification({
                                title: "<b style='color:white;'> Error!</b> ",
                ...
                $('#tbl_items tbody').on('input keyup', 'input.numeric', function() {
                    ...
                    var weight = parseFloat(accounting.unformat(row.find(oTableItems.weight).find('input.numeric').val()));
                    if (discount > price) {
                        showNotification({
                            title: "Invalid",
                            stat: "error",
                    ...
                    $(oTableItems.total_weight, row).find('input.numeric').val(accounting.formatNumber(total_weight, 2));
                    //console.log(net_vat);
                    reComputeTotal();
                });
