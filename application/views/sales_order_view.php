...
<div data-widget-group=" group1">
                                    ...
                                    <div id="div_user_list">
                                        <div class="panel panel-default" style="border: 4px solid #2980b9;">
                                            ...
                                            <div class="panel-body table-responsive">
                                                <h2 class="h2-panel-heading">Sales Order</h2>
                                                <hr>
                                                <div class="row">
    ...
    <div class="panel-ctrls" data-actions-container=""></div>
                                            ...
                                            <div class="panel-body">
                                                <h2 class="h2-panel-heading">SO # : <span id="span_so_no">SO-XXXX</span></h2>
                                                <hr>
...
<div id=" modal_confirmation" class="modal fade" tabindex="-1" role="dialog">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-8">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="col-md-4" id="label">
                                                                                        <label class="control-label boldlabel" style="text-align:right;">
                                                                                            <font color="red"><b>*</b></font> Contact Person :
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <div class="input-group">
                                                    ...
                                                    <!---modal-->
                                                    <div id="modal_new_department_sp" class="modal fade" tabindex="-1" role="dialog">
                                                        <!--modal-->
                                                        <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                                <div class="modal-header ">
                                                    ...
                                                    <footer role="contentinfo">
                                                        <div class="clearfix">
                                                            <ul class="list-unstyled list-inline pull-left">
                                                                <li>
                                                                    <h6 style="margin: 0;">&copy; 2016 JDEV OFFICE SOLUTION - </h6>
                                                                </li>
                                                            </ul>
