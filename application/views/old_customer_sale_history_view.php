...
<ol class="breadcrumb"  style="margin-bottom: 0;">
    ...
    <li><a href="Old_customer_sale_history">Sales History</a></li>
</ol>
...
<div id="div_sales_invoice_list">
    <div class="panel panel-default">
        ...
        <div class="row">
            <div class="col-sm-4">Old Sales/Cash Invoice History  </div>
            <div class="col-sm-8">
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_sales_invoice').DataTable({
            ...
            "bLengthChange":false,
                "order": [[ 2, "desc" ]],
            "ajax" : {
                "url" : "Old_customer_sale_history/transaction/list",
                "bDestroy": true,            
                "data": function ( d ) {
                        return $.extend( {}, d, {
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_export_selected').click(function(){
            window.open('Old_customer_sale_history/transaction/export-selected?id='+$('#cbo_customers').val()+"&pid="+$('#product_id').val());
        });

        $('#btn_export').click(function(){
            window.open('Old_customer_sale_history/transaction/export-all');
        });
