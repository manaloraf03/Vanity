                     ...
                     <tbody>
                         <?php
                            ...
                            <tr>
                                ...
                                <td width="10%" style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->weight * $item->so_qty, 2); ?></td>
                            </tr>
                         <?php $total_weight += $item->weight * $item->so_qty; } ?>
                         <tr>
                             <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;border-left: 1px solid gray;border-right: 1px solid gray;">Remarks:</td>
                         </tr>
                         <tr>
                             <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;"><?php echo $sales_order->remarks; ?></td>
                         </tr>
                     </tbody>
                     <tfoot>
                         <tr>
                             <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-left: 1px solid gray!important;"><b>Prepared By:</b></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: right;height: 30px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;"></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-left: 1px solid gray!important;"><b>Received By:</b></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;">Date:</td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;"></td>
