            ...
            <table width="100%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
                <thead style="margin-bottom: 10px;">
                    <tr>
                        ...
                        <th width="38%" class="bottom top" style="text-align: left;height: 30px;padding: 6px;">DESCRIPTION</th>
                        <th width="10%" class="bottom top" style="text-align: center;height: 30px;padding: 6px;">QTY</th>
                        <th width="10%" class="bottom top" style="text-align: right;height: 30px;padding: 6px;">S.PRICE</th>
                        <th width="18%" class="bottom top" style="text-align: right;height: 30px;padding: 6px;">TOTAL</th>
                        <th width="10%" class="bottom top" style="text-align: right;height: 30px;padding: 6px;">WEIGHT</th>
                        <th width="13%" class="bottom top" style="text-align: right;height: 30px;padding: 6px;">TOTAL WEIGHT</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($sales_invoice_items as $item) { ?>
                        <tr>
                            <td width="8%" class="" style="text-align: left;height: 15px;padding: 3px;"><?php echo $item->product_code; ?></td>
                            <td width="35%" class="" style="text-align: left;height: 15px;padding: 3px;"><?php echo $item->product_desc; ?></td>
                            <td width="10%" class="" style="text-align: center;height: 15px;padding: 3px;"><?php echo number_format($item->inv_qty, 0); ?></td>
                            <td width="10%" class="" style="text-align: right;height: 15px;padding: 3px;"><?php echo number_format($item->inv_price, 2); ?></td>
                            <td width="15%" class="" style="text-align: right;height: 15px;padding: 3px;"><?php echo number_format($item->inv_gross, 2); ?></td>
                            <td width="7%" class="" style="text-align: right;height: 15px;padding: 3px;"><?php echo number_format($item->weight, 2); ?></td>
                            <td width="15%" class="" style="text-align: right;height: 15px;padding: 3px;"><?php echo number_format($item->weight * $item->inv_qty, 2); ?></td>
                        </tr>
                    <?php
                        ...
                        $total_weight += $item->weight * $item->inv_qty;
                    } ?>
                    <!--             <tr>
