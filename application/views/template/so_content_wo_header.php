             ...
             <center>
                 <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
                     ...
                     <tbody>
                         ...
                         <tr>
                             <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 15px;padding: 6px;border-left: 1px solid gray;border-right: 1px solid gray;">Remarks:</td>
                         </tr>
                         <tr>
                             <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 15px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;"><?php echo $sales_order->remarks; ?></td>
                         </tr>
                     </tbody>
                     <tfoot>
                         <tr>
                             <td colspan="3" style="text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray!important;"><b>Prepared By:</b></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: right;height: 15px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;"></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray!important;"><b>Received By:</b></td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 15px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;">Date:</td>
                         ...
                         <tr>
                             <td colspan="3" style="text-align: left;height: 15px;padding: 6px;border-bottom: 1px solid gray!important;border-left: 1px solid gray!important;"></td>
