...
class Old_customer_sale_history extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['customers']=$this->Customers_model->get_old_list();
        $data['products']=$this->Products_model->get_old_list();
        $data['title'] = 'Old Customer Sales History';
        
        (in_array('3-8',$this->session->user_rights)? 
        $this->load->view('old_customer_sale_history_view', $data)
    ...
    function transaction($txn = null,$id_filter=null) {
        switch ($txn){
            ...
            case 'list':  //this returns JSON of Issuance to be rendered on Datatable
                ...
                $response['data']=$m_invoice->old_get_customer_sale_history($customer_id,$product_id);
            ...
            case 'export-selected':
                ...
                $excel->getActiveSheet()->setCellValue('A1',$company_info[0]->company_name)
                    ...
                    $i=8;
                    $total_sales = 0;
                    $invoices = $this->Sales_invoice_model->old_get_customer_sale_history($customer_id,$product_id);
            ...
            case 'export-all':
                ...
                $m_company=$this->Company_model;
                $company_info=$m_company->get_list();
                $m_customer_info = $this->Sales_invoice_model->old_get_customers_with_sales();
                ...
                $i++;
                    ...
                    $total_sales = 0;
                    $invoices = $this->Sales_invoice_model->old_get_customer_sale_history($customer->customer_id,0);
                        foreach($invoices as $invoice){
