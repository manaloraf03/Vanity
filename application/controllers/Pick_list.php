...
class Pick_list extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'Reorder Product Pick List ';
        ...
        $this->load->view('pick_list_view', $data)
    ...
    function transaction($txn = null) {
        switch ($txn) {
            ...
            case 'report':
                ...
                ($supplier_id == null ? $data['supplier_name'] = 'ALL' : $data['supplier_name']=$suppliers[0]->supplier_name);
                ($category_id == null ? $data['category_name'] = 'ALL' : $data['category_name']=$categories[0]->category_name);

                $this->load->view('template/pick_list_content',$data);
                break;
